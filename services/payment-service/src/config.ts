...
const envSchema = z.object({
  ...
  DB_NAME: z.string().min(1).default("payment_db"),
  ...
  PAYMENT_PROVIDER: z.enum(["STRIPE", "MOCK_GATEWAY"]).default("MOCK_GATEWAY"),
...
if (!parsedEnv.success) {
  console.error("❌ Invalid environment configuration in payment-service:");
